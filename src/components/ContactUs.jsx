...
const ContactUs = () => {
    ...
    formData.append("access_key", "c6660cd2-8b27-4deb-9196-835171c928b1");
    ...
    transition={{ staggerChildren: 0.2}}
     id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title='Reach out to us' desc='From strategy to execute, we craft digital solutions that move your business forward.'/>
